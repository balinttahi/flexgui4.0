...
function fidgetService(enumService, variableService, colorPickerService, scriptManagerService, $sce, $http, $timeout, $rootScope, iconService) {
    ...
    fidgets.templates = {
        ...
        "textInput": fidgets.getTemplate("views/fidgets/", "textInput", { _hidden: false, _name: "", _width: 100, _height: 30, _text: "variableService.demo.string" }, enumService.screenTypesEnum.Normal, null, "images/fidgets/textInput.png"),
        ...
        "radioButton": fidgets.getTemplate("views/fidgets/", "radioButton", { _hidden: false, _name: "", _width: 100, _height: 100, _value: "'Option1'", _options: 'Option1,Option2', _font: "inherit", _fontSize: 16, _fontColor: "#000000" }, enumService.screenTypesEnum.Normal, null, "images/fidgets/radioButton.png"),
        ...
        "image": fidgets.getTemplate("views/fidgets/", "image", { _hidden: false, _name: "", _width: 100, _height: 100, _value: "variableService.demo.image", scale: 'aspectFit' }, enumService.screenTypesEnum.Normal, null, "images/fidgets/image.png"),
